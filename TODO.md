...
Note: Hold/resume is currently a local/demo placeholder that only updates browser-side state. The DTMF keypad is complete, while the browser transport still depends on RTCDTMFSender support and SIP INFO fallback behavior per browser/session.
