    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => [
                ...
                'string',
                'max:128',
                Rule::unique('call_queues', 'slug')->where(fn ($query) => $query->where('tenant_id', $tenantId)),
            ],
            ...
            'music_on_hold' => ['nullable', 'string', 'max:128'],
            'announce_position' => ['sometimes', 'boolean'],
            'announce_estimated_wait' => ['sometimes', 'boolean'],
            'overflow_destination_type' => ['nullable', Rule::in(['extension', 'user', 'ring_group', 'queue'])],
            'overflow_destination_id' => ['nullable', 'integer', 'min:1'],
